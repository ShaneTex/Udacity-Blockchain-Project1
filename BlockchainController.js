...
class BlockchainController {
    ...
    // Enpoint to check or validate chain (GET Endpoint)
    //Shane added this validation check endpoint as last task in the rubric
    validateChain() {
        this.app.get("/validateChain", async (req, res) => {
            if(req) {
                ...
                return res.status(404).send("Blockchain has no rows!");
            }
